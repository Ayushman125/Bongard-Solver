...
class LogoGenerator:
    ...
    def __init__(self, cfg: Dict[str, Any]):
        ...
        self.bg_textures = self._load_background_textures(self.cfg.get('background_texture_path'))
    ...
    def make_problem(self, problem_id: int) -> Tuple[Any, ...]:
        ...
        return (query_img1_np, query_img2_np, problem_label,
                ...
                query_conf1, query_conf2, support_confs_flat) # Added image confidences
...
if __name__ == '__main__':
    ...
    dummy_query_bboxes_view2, dummy_query_masks_view2, \
    dummy_support_bboxes_flat, dummy_support_masks_flat, \
    query_conf1, query_conf2, support_confs_flat = problem_data
