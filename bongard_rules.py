...
LOGIC_EXISTS = RuleAtom("EXISTS", 1) # e.g., EXISTS(obj, color(obj, red))
LOGIC_FORALL = RuleAtom("FORALL", 1) # e.g., FORALL(obj, shape(obj, circle))
LOGIC_COUNT = RuleAtom("COUNT", 2) # e.g., COUNT(obj, shape(obj, circle), 3) - for counting rules
...
ALL_BONGARD_RULES["all_circles"] = BongardRule(
    ...
    program_ast=[{"op": "FORALL", "args": ["O", {"op": "shape", "args": ["O", {"op": "circle"}]}]}],
...
ALL_BONGARD_RULES["all_same_color_red"] = BongardRule(
    ...
    program_ast=[{"op": "FORALL", "args": ["O", {"op": "color", "args": ["O", {"op": "red"}]}]}],
...
ALL_BONGARD_RULES["exists_large_square"] = BongardRule(
    ...
    program_ast=[
        {"op": "EXISTS", "args": ["O", {"op": "AND", "args": [
            {"op": "shape", "args": ["O", {"op": "square"}]},
            {"op": "size", "args": ["O", {"op": "large"}]}
        ]}]}
    ],
...
ALL_BONGARD_RULES["no_hollow_triangle"] = BongardRule(
    ...
    program_ast=[
        {"op": "NOT", "args": [
            {"op": "EXISTS", "args": ["O", {"op": "AND", "args": [
                {"op": "shape", "args": ["O", {"op": "triangle"}]},
                {"op": "fill", "args": ["O", {"op": "hollow"}]}
            ]}]}
        ]}
    ],
...
ALL_BONGARD_RULES["all_red_or_blue"] = BongardRule(
    ...
    program_ast=[
        {"op": "FORALL", "args": ["O", {"op": "OR", "args": [
            {"op": "color", "args": ["O", {"op": "red"}]},
            {"op": "color", "args": ["O", {"op": "blue"}]}
        ]}]}
    ],
...
ALL_BONGARD_RULES["small_above_large"] = BongardRule(
    ...
    program_ast=[
        {"op": "EXISTS", "args": ["O1", {"op": "EXISTS", "args": ["O2", {"op": "AND", "args": [
            {"op": "size", "args": ["O1", {"op": "small"}]},
            {"op": "size", "args": ["O2", {"op": "large"}]},
            {"op": "above", "args": ["O1", "O2"]}
        ]}]}]}
    ],
...
ALL_BONGARD_RULES["all_aligned_horizontally"] = BongardRule(
    ...
    program_ast=[
        {"op": "FORALL", "args": ["O1", {"op": "FORALL", "args": ["O2", {"op": "AND", "args": [
            {"op": "NOT", "args": [{"op": "EQ", "args": ["O1", "O2"]}]}, # O1 != O2
            {"op": "aligned_horizontally", "args": ["O1", "O2"]}
        ]}]}]}
    ],
...
ALL_BONGARD_RULES["circle_in_square"] = BongardRule(
    ...
    program_ast=[
        {"op": "EXISTS", "args": ["C", {"op": "EXISTS", "args": ["S", {"op": "AND", "args": [
            {"op": "shape", "args": ["C", {"op": "circle"}]},
            {"op": "shape", "args": ["S", {"op": "square"}]},
            {"op": "contains", "args": ["S", "C"]} # Parent, Child
        ]}]}]}
    ],
...
ALL_BONGARD_RULES["objects_form_line"] = BongardRule(
    ...
    program_ast=[
        {"op": "FORALL", "args": ["O1", {"op": "EXISTS", "args": ["O2", {"op": "AND", "args": [
            {"op": "NOT", "args": [{"op": "EQ", "args": ["O1", "O2"]}]},
            {"op": "OR", "args": [
                {"op": "aligned_horizontally", "args": ["O1", "O2"]},
                {"op": "aligned_vertically", "args": ["O1", "O2"]}
            ]}
        ]}]}]}
    ],
...
ALL_BONGARD_RULES["exactly_three_circles"] = BongardRule(
    ...
    program_ast=[
        {"op": "COUNT", "args": ["O", {"op": "shape", "args": ["O", {"op": "circle"}]}, 3]}
    ],
    logical_facts=["count(O, shape(O, circle), 3)"]
)
...
ALL_BONGARD_RULES["more_squares_than_circles"] = BongardRule(
    ...
    program_ast=[
        {"op": "GT", "args": [
            {"op": "COUNT", "args": ["O", {"op": "shape", "args": ["O", {"op": "square"}]}, None]}, # None for count value
            {"op": "COUNT", "args": ["O", {"op": "shape", "args": ["O", {"op": "circle"}]}, None]}
        ]}
    ],
...
ALL_BONGARD_RULES["not_all_same_size"] = BongardRule(
    ...
    program_ast=[
        {"op": "NOT", "args": [
            {"op": "EXISTS", "args": ["S", {"op": "FORALL", "args": ["O", {"op": "size", "args": ["O", "S"]}]}]}
        ]}
    ],
    logical_facts=["not(exists(S, forall(O, size(O, S))))"]
)
...
ALL_BONGARD_RULES["red_circle_and_blue_square"] = BongardRule(
    ...
    program_ast=[
        {"op": "AND", "args": [
            {"op": "EXISTS", "args": ["O1", {"op": "AND", "args": [
                {"op": "shape", "args": ["O1", {"op": "circle"}]},
                {"op": "color", "args": ["O1", {"op": "red"}]}
            ]}]},
            {"op": "EXISTS", "args": ["O2", {"op": "AND", "args": [
                {"op": "shape", "args": ["O2", {"op": "square"}]},
                {"op": "color", "args": ["O2", {"op": "blue"}]}
            ]}]}
        ]}
    ],
...
ALL_BONGARD_RULES["all_circles_are_small"] = BongardRule(
    ...
    program_ast=[
        {"op": "FORALL", "args": ["O", {"op": "IMPLIES", "args": [
            {"op": "shape", "args": ["O", {"op": "circle"}]},
            {"op": "size", "args": ["O", {"op": "small"}]}
        ]}]}
    ],
    # For Prolog, implication (A -> B) is often represented as (B :- A).
    # Or, forall(X, (shape(X, circle) -> size(X, small)))
